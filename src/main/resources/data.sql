...
INSERT INTO foods (id, image_url, name, base_price, description, brand_id, category_id)
VALUES
    (1, 'https://media.loveitopcdn.com/24813/thumb/600x600/z4564243657819-f5b393659a568f6a0d4e329ac92bb3b4.jpg?zc=1', 'Gà rán sốt cay', 59000.0, 'Món gà rán cay ngon tuyệt vời, giòn rụm, đậm đà hương vị.', 3, 3),
    (2, 'https://jollibee.com.vn/media/catalog/product/cache/11f3e6435b23ab624dc55c2d3fe9479d/g/_/g_s_t_cay_-_4-compressed.jpg', 'Cơm gà sốt cay', 65000.0, 'Cơm gà sốt cay thơm ngon, đậm đà, phù hợp khẩu vị mọi người.', 4, 3),
    (3, 'https://cdn-media.hanoitimes.vn/2021/3/20/z2388286964567_365ff5742704671dadede255cf83f869.jpg', 'Bánh mì thập cẩm', 29000.0, 'Bánh mì thập cẩm với nhiều loại nhân hấp dẫn, ngon miệng.', 2, 1),
    (4, 'https://pizzahut.vn/_next/image?url=https%3A%2F%2Fcdn.pizzahut.vn%2Fimages%2FWeb_V3%2FProducts_MenuTool%2FBulgogi._20251029134256KCW.webp&w=1024&q=100', 'Pizza bò Hàn Quốc', 120000.0, 'Pizza bò Hàn Quốc với phô mai béo ngậy và thịt bò mềm mại.', 5, 6),
    (5, 'https://pizzahut.vn/_next/image?url=https%3A%2F%2Fcdn.pizzahut.vn%2Fimages%2FWeb_V3%2FProducts_MenuTool%2FCheese%20Lover%20with%20honey._20250317172143IO1.webp&w=1170&q=75', 'Pizza phô mai', 110000.0, 'Pizza phô mai thơm ngon, béo ngậy với lớp phô mai tan chảy hấp dẫn.', 5, 6),
    (6, 'https://noiphosaigon.vn/wp-content/uploads/2020/09/cach-lam-banh-bao-nhan-thit-thom-ngon.jpg', 'Bánh bao thịt', 25000.0, 'Bánh bao thịt nóng hổi, nhân thịt thơm ngon, mềm mịn.', 3, 7),
    (7, 'https://banhmihuynhhoa.vn/wp-content/uploads/2024/10/dscf0711-min-1-300x300.jpg', 'Bánh mì Huỳnh Hoa', 40000.0, 'Bánh mì Huỳnh Hoa đặc sản nổi tiếng, giòn tan, đậm đà hương vị.', 2, 1);