package com.bqtankiet.angiday.infrastructure.payment.momo.mservice.processor;

import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.models.HttpResponse;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.models.PaymentRequest;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.models.PaymentResponse;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.enums.*;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.shared.constants.Parameter;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.shared.exception.MoMoException;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.config.Environment;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.shared.utils.Encoder;
import com.bqtankiet.angiday.infrastructure.payment.momo.mservice.shared.utils.LogUtils;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, com.bqtankiet.angiday.infrastructure.payment.momo.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        try {
     ...
     * @return
     */
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo, String returnUrl,
                                                       String notifyUrl, String extraData, RequestType requestType, Boolean autoCapture) {
